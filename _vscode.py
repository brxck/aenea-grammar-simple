...
mapping = {
    ...
    ### Editing ###
    "innie [<n>]": Key("c-rbracket:%(n)d"),
    "outie [<n>]": Key("c-lbracket:%(n)d"),
    "slide [<n>]": Key("c-enter"),
    "slip [<n>]": Key("cs-enter"),
    "dupe up": Key("c-c/3, cs-enter, c-v/3, backspace"),
    "dupe down": Key("c-c/3, c-enter, c-v/3, backspace"),    
    "comment": Key("c-slash"),
    ...
    "scrup [<n>]": Key("a-pgup:%(n)d"),
    "scrown [<n>]": Key("a-pgdown:%(n)d"),
    "scrup page [<n>]": Key("a-pgup:%(n)d"),
    "scrown page [<n>]": Key("a-pgdown:%(n)d"),

    ### Subword Navigation extension ###
    "left [<n>] (subword|subwords)": Key("a-left/3:%(n)d/10"),
    "right [<n>] (subword|subwords)": Key("a-right/3:%(n)d/10"),
    "take [<n>] (subword|subwords)": Key("sa-left/3:%(n)d/10"),
    "grab [<n>] (subword|subwords)": Key("sa-right/3:%(n)d/10"),
    "whack [<n>] (subword|subwords)": Key("a-backspace/3:%(n)d/10"),
    "bump [<n>] (subword|subwords)": Key("a-delete/3:%(n)d/10"),
